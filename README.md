...
### Usage 1`
- `>> FileReaderApplication data.csv ENC_AES128 COM_GZIP` //ENC = encrypt, COM = compression
...
### Usage 2
- `>> FileReaderApplication data.csv COM_GZIP`// COM = compression
...
### Usage 3
- `>> FileReaderApplication data.csv ENC_AES128` //ENC = encrypt
